...
| FogGUI::start | Magic Number | Extract Constant — WINDOW_SIZE | 99371  |
| FogGUI::revela | Magic Number | Extract Constant — CELL_SIZE | 99371  |
| Ship::occupies | Loop can be replaced | Replace with 'contains' | 99371 |
| Ship::buildShip | Old style switch | Replace with enhanced 'switch' | 99371 |
| Galleon::Galleon | Old style switch | Replace with enhanced 'switch' | 99371 |